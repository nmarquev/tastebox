...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    ...
    /** Si es true, el diálogo se cierra al hacer clic afuera. Por defecto NO se cierra. */
    allowOutsideClose?: boolean;
  }
>(({ className, children, closeButtonClassName, hideCloseButton, allowOutsideClose, onInteractOutside, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ...
      onInteractOutside={(e) => {
        // Por defecto: clic/foco afuera NO cierra el diálogo (evita cierres accidentales).
